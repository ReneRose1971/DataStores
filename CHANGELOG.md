...
### Features
- [x] Thread-sichere Operationen auf allen Stores
- [x] Globale (Singleton) und lokale (isolierte) Stores
- [x] Snapshots mit optionalen Filtern
- [x] Asynchrone Persistierung mit Race-Condition-Schutz
- [x] Bulk-Operationen für Performance
- [x] Explizite Invarianten und Verhaltensgarantien
...
[Unreleased]: https://github.com/ReneRose1971/DataStores/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/ReneRose1971/DataStores/releases/tag/v1.0.0
